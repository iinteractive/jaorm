...
const JaormError = require("./jaorm_error.js");
...
class Schema {
  constructor(db_connection_options, schema_options = {}, mapping = {}) {
    ...
    self.serialize_objects = schema_options.serialize_objects || true;
  ...
  async initialize() {
    ...
    try {
      ...
      throw new JaormError("unable to retrieve table information");
    }
  ...
  base_query(table_name) {
    const self = this;
    return self.driver.base_query(table_name);
  }
  ...
  async raw(options) {
    ...
    return await self.driver.raw(options);
  }
}
